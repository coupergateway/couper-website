...
import HomeDesktop from '../assets/images/HomeDesktop'
import HomeMobileTablet from '../assets/images/HomeMobileTablet'
      ...
      <Structure.Wrapper>
        <Structure.Hero>
          ...
          <Structure.Container>
            ...
            <Structure.Distance />
            <Structure.Distance />
            <Cta to='/docs#getting-started'>Get Started</Cta>
            <News />
          </Structure.Container>
        </Structure.Hero>
      </Structure.Wrapper>
